...
@RestController
@Slf4j
public class ReplySwaggerController {

    private final Logger LOGGER = LoggerFactory.getLogger(PostSwaggerController.class);


    private final ReplyService replyService;

    @Autowired
    public ReplySwaggerController(ReplyService replyService)
    {
                                      ...
                                      @RequestParam(value = "comment")String comment)
    {
        ...
        ReplyResultDto replyResultDto = replyService.Reply_write(replyRequestDto);
