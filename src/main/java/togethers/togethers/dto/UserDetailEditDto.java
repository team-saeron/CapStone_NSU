...
@Getter
@NoArgsConstructor
public class UserDetailEditDto {
    private String mbti;
    ...
    public UserDetailEditDto(String mbti, String wish_roommate, int monthly_fee, String nickname, String regions, int lease_fee, String life_cycle, String smoking, String pet){
        this.mbti=mbti;
